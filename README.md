...
- initial value rubrics,
- evaluation cadences,
- a visible contribution log,
- reward and retained-value rights,
- voice, exit, and contestability guarantees,
- governance-change pathways,
- and phase transitions from explicit founder control toward legitimacy-preserving decentralization.
...
Status: early public research program.
